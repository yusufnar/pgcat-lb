...
# Show PgCat status after lag created
echo ""
echo "[$(date +%H:%M:%S)] PgCat pool status (after lag on both):"
...
echo "  Note: PgCat does NOT detect replication lag. Lagging replicas remain in the pool."
for i in {1..5}; do
